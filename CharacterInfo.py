...
class CharacterInfo:
	# 		(17)    con, st, dex, intelligence, cha, mspeed, reg, color, resistances(fr,fi,po,ac,sh,ex)   class equipment,   innate weapons (power, ability)
	...
	races = {
		...
		"Dhampir": 		[[4, 4, 4, 4, 3, 0.9, 9, [3, 0, 0, 0, 0, 0], "red"], [], "Baphomet"],
		"Ghoul": 		[[4, 4, 4, 2, 1, 1.1, 5, [0, 0, 0, 3, 0, 0], "darkred"], [("feral bite", True)], "Ra"],
		...
		"Dread": 		[[5, 5, 1, 4, 1, 1.5, 50, [1, 0, 3, 0, 0, 2], "steel"], [("repair matrix", True)], "Omnus"],
	...
	race_starting_equipment = {
		...
		"Dhampir": [["iron axe", "buckler shield", "hide armor"],
				   ["mace", "buckler shield", "hide armor"],
				   ["shortbow", "iron shortsword", "iron arrow", "leather armor"],
				   ["iron dagger", "iron dagger", "throwing knife", "leather armor"],
				   ["oak staff", "wool robes", ("magic missile", False)],
		...
		"Dread": [["iron axe", "buckler shield", "hide armor"],
					 ["hammer", "buckler shield", "hide armor"],
