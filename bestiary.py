...
class Monsters():
	...
	array = {
		...
		"Direwolf Cannibal" : ["c","red","beast",2,  3,4,4,2,1,0.75, 8, [1,0,0,0,0,0], ['blood fangs'] , ['wolf pelt'],['furious charge']],
		"Direwolf Alpha" : 	  ["A","darkred","beast",3,  5,5,5,2,1,0.8, 15, [1,0,0,0,0,0], ['demon fangs','blood fangs'] , ['direwolf pelt'],['furious charge']],
		...
		"Goblin Nob" : 	       ["g","orange","goblin",2,  4,3,2,1,2,0.95, 8, [0,0,0,0,0,0], ['smasha','choppa'] , ['troll hide','spider hide']],
		...
		"Living Corpse" : 	  ["z","bone","undead",1,  2,2,1,1,3,1.3, 4, [0,0,0,0,0,0], ['iron longsword','iron axe','iron dagger','mace'] , ['tattered garments',]],
		...
		"Dark Justicar" :   ["j","magenta","elf",6,  5,4,6,4,4,0.85, 60, [1,0,0,0,0,0], ['sunspear',['thornknife','thornknife']] , ['blackscale','thornmail'], ['gauntlet shield','furious charge']],
		...
		"Ogre Berserker" : 	 ["O","red","ogre",5,  6,7,3,1,1,1.2, 15, [2,2,5,2,0,1], ['spiked club','bone club'] , ['berserker mail','ironscale mail'],['furious charge']],
		...
		"Dane, Son of Erick" : ["D","yellow","troll",8,  8,7,2,1,5,1.3, 200, [1,1,0,0,0,1], ["Mjölnir"] , ['steel plate'],['Flame Dragon']],

		# Dragons
		"Flame Dragon" : ["D","red","dragon",10,  12,8,7,6,8,1.1, 500, [0,2,0,0,0,0], ['dragon fangs'] , ['fire dragonscales'], ['dragon tail']],
		"Frost Dragon" : ["D","cyan","dragon",10,  14,7,6,4,7,1.2, 500, [2,0,0,0,0,0], ['dragon fangs'] , ['frost dragonscales'], ['frost breath','dragon tail']],
		"Dracolich" :  	 ["D","bone","dragon",12,  14,8,6,5,10,1.0, 500, [0,0,4,0,0,0], ['dragon fangs'] , ['bone dragonscales'],['dragon tail','horns']],

		# the Four Horsemen
		"War" :  	   ["W","red","spirit",7,  6,8,4,1,5,1.2, 100, [1,1,0,0,0,1], ["warscythe"] , ['steel chainmail'],['Tortured Warsteed']],
		"Famine" :     ["F","blue","spirit",7,  6,8,4,1,5,1.2, 100, [1,1,0,0,0,1], ["warscythe"] , ['steel chainmail'],['Tortured Warsteed']],
		"Pestilence" : ["P","green","spirit",7,  6,8,4,1,5,1.2, 100, [1,1,0,0,0,1], ["warscythe"] , ['steel chainmail'],['Tortured Warsteed']],
		"Death" :  	   ["D","purple","spirit",7,  6,8,4,1,5,1.2, 100, [1,1,0,0,0,1], ["warscythe"] , ['steel chainmail'],['Tortured Warsteed']],

		# Mounts
		"Wild Horse" : 		   ["h","brown","beast",3,  4,2,4,1,8,0.7, 15, [0,0,0,0,0,0], ['hooves'] , ['horse hide']],
		"Tortured Warsteed" :  ["h","darkred","beast",3,  3,3,3,1,8,0.7, 15, [2,2,0,0,0,0], ['hooves'] , ['horse hide']],
