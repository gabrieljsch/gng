...
class Monsters():
	...
	array = {
		...
		# Goblins
		"Goblin" : 		   	 ["g",1,  1,2,3,1,1,0.9, 4, ['stabba','goblin spear','club','bone club'] , ['animal skin','bear hide']],
		"Goblin Archer" :    ["a",1,  2,1,4,1,1,0.85, 4, ['stabba'] , ['animal skin','bear hide'], ['goblin bow']],
		"Goblin Skirmisher" :["g",1,  3,2,3,1,1,0.85, 6, ['slica','choppa','bone club'] , ['bear hide'], ['buckler shield']],
		"Witch Goblin" :     ["w",2,  3,3,3,3,2,0.9, 8, ['stabba','bone club'] , ['troll hide'], ['poison breath']],
		...
		# Uruks
		"Uruk Warrior" :   ["u",3,  4,4,3,2,3,1.0, 15, ['hooked longsword'] , ['blackiron plate'], ['blackiron shield']],
		...
		"Uruk Bodyguard" : ["B",5,  6,5,3,2,3,1.2, 30, ['hooked greatsword','uruk-hai pike'] , ['blackiron plate'], ['blackiron shield','shield hit']],
		"Uruk Warlord" :   ["U",6,  6,6,3,2,3,1.0, 50, ['hooked greatsword'] , ['blackiron plate']],

		# Undead
		"Living Corpse" : 	  ["z",1,  2,2,1,10,10,1.3, 4, ['iron longsword','iron axe','iron dagger','mace'] , ['tattered garments',]],
		...
		"Black Eye Disciple" :  ["b",3,  4,3,3,3,4,0.9, 14, ['spiked mace'] , ['tainted robe'],['dark bolt']],
		"Black Eye Destroyer" : ["D",5,  4,3,3,5,4,1.0, 30, ['spiked mace'] , ['tainted robe'], ['dark transformation','bloodreave']],
		"Abomination" : 		["A",5,  6,6,1,1,4,1.6, 30, ['fist smash'] , ['tainted robe']],
		"Black Eye Prophet" :   ["P",6,  5,3,3,7,4,1.0, 50, ['spiked mace'] , ['tainted robe'], ['dark transformation','bloodreave']],
		"Black Eye Chosen" :    ["C",7,  7,3,3,6,4,1.0, 100, ['spiked mace'] , ['tainted robe'], ['dark transformation','bloodreave']],
